...
export DSL_METADATA='{"flavour": "local_docker", "stage":"undeploy", "retryMaxAttempts": 1,
"stateConfig": {"provider":"S3", "uri":"s3://odin-components-state-stag/odin-component-interface-nginx-test.tfstate"}}'
