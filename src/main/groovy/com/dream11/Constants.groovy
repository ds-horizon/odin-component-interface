...
class Constants {
    ...
    public final static String DSL_METADATA = "DSL_METADATA"
    public final static String BASE_CONFIG = "BASE_CONFIG"
    public final static String FLAVOUR_CONFIG = "FLAVOUR_CONFIG"
    public final static String OPERATION_CONFIG = "OPERATION_CONFIG"
    public final static String STAGE_NAME = "stageName"
    public final static String COMPONENT_METADATA = "COMPONENT_METADATA"
